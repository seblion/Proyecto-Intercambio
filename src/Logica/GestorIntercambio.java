...
//        if (!validarCondicionesIniciales(cuentaOferente, cuentaReceptor, publicacionOferente)) {
//            throw new IllegalStateException("No se cumplen las condiciones para iniciar el intercambio");
//        }
//
//        Intercambio nuevoIntercambio = new Intercambio(cuentaOferente, cuentaReceptor, publicacionOferente);
...
//    if (!publicacionReceptor.perteneceA(intercambio.getCuentaReceptor())) {
...
//        return cuentaOferente.estaActiva() &&
//                cuentaReceptor.estaActiva() &&
//                publicacion.estaDisponible() &&
//                publicacion.perteneceA(cuentaOferente) &&
//                !intercambioDAO.existenIntercambiosPendientes(cuentaOferente, cuentaReceptor);
//    }
